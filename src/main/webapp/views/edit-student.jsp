        ...
        <div class="col-lg-6">
            ...
            <form action="<%=request.getContextPath()%>/studentservlet" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="studentName" name="name" placeholder="Họ và tên" value="${studentDTO.name}">
                </div>
                <div class="form-group">
                    <label for="age">Ngay sinh</label>
                    <input type="date" class="form-control" id="age" name="birthday" placeholder="Tuổi" value="${studentDTO.birthday}">
                </div>
                <div class="form-group">
                    <label for="">Chon lop</label>
                    <select class="form-control" name="classId" id="">
                        <c:forEach items="${list}" var="item">
                            <option value="${item.class_id}">gshs</option>
                        </c:forEach>
